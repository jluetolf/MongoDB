...
public class MongoDbApplicationCSVBuilder implements CommandLineRunner {
  ...
  public static void main(String[] args) {
    SpringApplication.run(MongoDbApplicationCSVBuilder.class, args);
  }
  ...
  public void run(String... args) throws Exception {
    ...
    for (Trip trip : trips) {
      ...
      row[0] = Long.toString(id.addAndGet(1L));
      row[1] = mapper.writeValueAsString(trip);
